...
import (
	...
	"github.com/togisuma/standard-echo-serverless/base/adapter/api/errorhandler"
	"github.com/togisuma/standard-echo-serverless/base/adapter/api/validator"
	"github.com/togisuma/standard-echo-serverless/base/adapter/middlewares"
	"github.com/togisuma/standard-echo-serverless/base/adapter/routes"
	"github.com/togisuma/standard-echo-serverless/base/sharedkarnel/customlogger"
	"github.com/togisuma/standard-echo-serverless/di"
	"go.uber.org/dig"
	"go.uber.org/zap"
	"log"
	"net/http"
